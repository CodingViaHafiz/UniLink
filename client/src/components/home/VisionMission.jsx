    ...
    <div className="relative overflow-hidden rounded-3xl bg-white border-slate-200 shadow-sm px-6 py-10 sm:px-10 sm:py-14">
      ...
      <MotionCard>
        <div className="mb-8 text-center sm:text-left">
          ...
          <span className="mt-3 inline-block rounded-full border border-emerald-200 bg-emerald-50 px-4 py-1.5 text-xs font-bold text-emerald-700">
            Brightening the Nation's Future
          </span>
        </div>
      </MotionCard>
